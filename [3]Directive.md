...
jdlee@LeeJD:~/StkDog$ sudo yo angular:directive stk-Watchlist-Panel
   create app/scripts/directives/stk-watchlist-panel.js
   create test/spec/directives/stk-watchlist-panel.js
jdlee@LeeJD:~/StockDog$ 
jdlee@LeeJD:~/StockDog$ ls app/scripts/directives/stk-watchlist-panel.js 
app/scripts/directives/stk-watchlist-panel.js
jdlee@LeeJD:~/StockDog$ cat app/scripts/directives/stk-watchlist-panel.js 
'use strict';
...
-    };
-  });
jdlee@LeeJD:~/StockDog$ vim app/scripts/directives/stk-watchlist-panel.js 
jdlee@LeeJD:~/StockDog$ cat app/scripts/directives/stk-watchlist-panel.js 
+'use strict';
+
+/**
...
```diff
jdlee@LeeJD:~/StockDog$ mkdir app/views/templates/
jdlee@LeeJD:~/StockDog$ vim app/views/templates/watchlist‐panel.html
jdlee@LeeJD:~/StockDog$ cat app/views/templates/watchlist‐panel.html
...
```diff
jdlee@LeeJD:~/StockDog$ vim app/views/templates/addlist‐modal.html
jdlee@LeeJD:~/StockDog$ cat app/views/templates/addlist‐modal.html
